...
export type Booking = { id: number | string; clientId?:number|string; source?:'admin'|'public'|'phone'; date: string; time: string; client: string; car: string; service: string; tech: string; price: number; discount: number; paymentMethod: PaymentMethod; durationMinutes: number; status: Status; phone: string }
