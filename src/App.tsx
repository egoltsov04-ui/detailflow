...
export default function App() {
  ...
  useEffect(()=>{
    if(!supabase || !tenantId)return
    void Promise.all([
      supabase.from('staff_shifts').select('id,staff_id,started_at,ended_at').eq('tenant_id',tenantId).order('started_at',{ascending:false}).limit(40),
